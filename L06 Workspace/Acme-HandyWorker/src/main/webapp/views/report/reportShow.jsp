...
<security:authorize access="hasRole('CUSTOMER')">
	...
	<div>
		<spring:message code="report.details"></spring:message>
	...
	<div>
		<spring:message code="report.info"></spring:message>
		<display:table name="report" id="row" requestURI="${requestURI}" class="displaytag">
	...
	<div>
		...
		<display:table name="report.notes" id="row" requestURI="${requestURI}" class="displaytag" pagesize="5"> 
			...
			<display:column>
				<a href="note/customer/show.do?noteId=${row.id}"><spring:message code="details" /></a>
			</display:column>
		</display:table>
	</div>
	<div>
		<a href="note/customer/create.do?id=${report.id}"><input type="button" value="<spring:message code='button.create'></spring:message>"></a>
	</div>
</security:authorize>
 </div>
</body>