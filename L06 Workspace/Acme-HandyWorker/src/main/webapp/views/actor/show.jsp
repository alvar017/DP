...
<div class="content">
	...
	<table>
		<tr>
			...
			<img width="95"
				class="customer_photo" src="${actor.photo}"
				alt=<jstl:out value="${actor.photo}"></jstl:out> /></td>
		</tr>
		<tr>
			<td><spring:message code="actor.name" /> <jstl:out
					value="${actor.name}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.middlename" /> <jstl:out
					value="${actor.middleName}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.surname" /> <jstl:out
					value="${actor.surname}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.address" /> <jstl:out
					value="${actor.address}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.phone" /> <jstl:out
					value="${actor.phone}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.email" /> <jstl:out
					value="${actor.email}"></jstl:out></td>
		</tr>
		<tr>
			<td><spring:message code="actor.username" /> <jstl:out
					value="${actor.userAccount.username}"></jstl:out></td>
		</tr>
		<security:authorize access="hasRole('CUSTOMER')">
		<tr>
			<td><spring:message code="score" /> <jstl:out
					value="${customer.calification}"></jstl:out></td>
		</tr>
		</security:authorize>
		<tr>
			<td>
				<p>
					...
					<display:column titleKey="button.edit">
						<a href="socialProfile/actor/edit.do?socialProfileId=${row.id}"><spring:message
								code="button.edit" /></a>
					</display:column>
					<display:column titleKey="delete">
						<a href="socialProfile/actor/delete.do?socialProfileId=${row.id}"><spring:message
								code="delete" /></a>
					</display:column>
					...
					<p>
						<input type="button"
							...
							onclick="location.href='socialProfile/actor/create.do';" />
					</p>
				</display:table>
			</td>
		</tr>
