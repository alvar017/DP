  ...
  <section id="main-content">
    ...
    <article>
      ...
      <div class="content">
    	...
    	<form:form class="formularioEdicion" method="POST" modelAttribute="sponsor" action="sponsor/edit.do">
          	<form:hidden path="id"/>
			...
			<form:label path="phone"><spring:message code="sponsor.phone" /></form:label>(+${phone})
