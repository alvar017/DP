  ...
  <section id="main-content">
    ...
    <article>
      ...
      <div class="content">
    	...
    	<form:form class="registerAdministrator" method="POST" modelAttribute="administrator" action="administrator/create.do">
          	<form:hidden path="id"/>
			...
			<form:label path="address"><spring:message code="administrator.address" /></form:label>
