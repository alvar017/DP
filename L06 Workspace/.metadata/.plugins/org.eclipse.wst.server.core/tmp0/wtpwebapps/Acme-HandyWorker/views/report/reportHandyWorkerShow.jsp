...
<security:authorize access="hasRole('HANDYWORKER')">
	...
	<div>
		...
		<display:table name="report.notes" id="row" requestURI="${requestURI}" class="displaytag" pagesize="5"> 
			...
			<display:column>
				<a href="note/handyWorker/show.do?noteId=${row.id}"><spring:message code="details" /></a>
			</display:column>
		</display:table>
	</div>
	<div>
		<a href="note/handyWorker/create.do?id=${report.id}"><input type="button" value="<spring:message code='button.create'></spring:message>"></a>
	</div>
</security:authorize>
 </div>
</body>