...
public class ProfileController extends AbstractController {
	...
	@RequestMapping(value = "/inspiring-quotes", method = RequestMethod.GET)
	public ModelAndView action1() {
		...
		quotes.add("Cogito, ergo sum -- René Déscartes");

		Collections.shuffle(quotes);
		quotes = quotes.subList(0, 3);

		result = new ModelAndView("profile/inspiring-quotes");
