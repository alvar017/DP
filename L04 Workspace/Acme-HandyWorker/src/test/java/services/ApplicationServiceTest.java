...
public class ApplicationServiceTest extends AbstractTest {
	...
	public void testListingApplication() {
		...
		this.applicationRepository.flush();
		Assert.isTrue(this.applicationService.findAllByCustomer(saveCustomer1).contains(saveApplication1) && this.applicationService.findAllByCustomer(saveCustomer1).contains(saveApplication2)
			&& !this.applicationService.findAllByCustomer(saveCustomer1).contains(saveApplication3));
	}
}
