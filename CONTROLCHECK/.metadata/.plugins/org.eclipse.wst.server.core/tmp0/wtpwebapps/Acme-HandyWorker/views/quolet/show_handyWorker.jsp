	...
	<section id="main-content">
    	...
    	<article>
      		...
      		<div class="content">
				...
				<table>
					<tr><td><strong><spring:message code="details" /></strong></td></tr>
    				...
    				<tr><td><spring:message code="customer" /><jstl:out value="${quolet.customer.name} " ></jstl:out></td></tr>			
			...
			<form method="get" action="quolet/handyWorker/list.do">
				<button type="submit">
