...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
  ...
  <section id="main-content">
    ...
    <article>
      <header>
        <h2>
        	<spring:message code="referee.edit.socialProfile" />
        </h2>
      </header>
      
      <div class="content">
    		
    	<form:form class="formularioEdicion" method="POST" modelAttribute="socialProfile" action="socialProfile/referee/edit.do">
          	<form:hidden path="id"/>
